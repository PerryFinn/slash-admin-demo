...
const CODE_BOX_CLASS =
  "whitespace-pre-wrap rounded-md border border-gray-200 bg-gray-50 p-3 text-sm font-mono overflow-x-auto";
...
function SnippetBlock({ title, description, code, children }: SnippetBlockProps) {
  return (
    <div className="flex flex-col gap-2 rounded-md border border-gray-200 p-3">
      ...
      <pre className={CODE_BOX_CLASS}>{code}</pre>
