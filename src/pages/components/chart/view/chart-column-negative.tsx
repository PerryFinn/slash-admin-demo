    ...
    series: [
      {
        name: series[0].name,
        type: "bar",
        data: series[0].data.map((v) => {
          if (v < -45) return { value: v, itemStyle: { color: paletteColors.warning.default } };
          if (v < 0) return { value: v, itemStyle: { color: paletteColors.info.default } };
          return v;
        }),
        barWidth: 14,
      },
